...
export const SPANISH_STORYBOOKS: Storybook[] = [
  ...
  { id: 'es-3', slug: 'ruido-operativo', title: 'Ruido operativo y naturaleza', language: 'es', pdfPath: getPdfPath('ruido-operativo'), bilingualPairId: 'en-3' },
  ...
  { id: 'es-9', slug: 'monitoreo-kpis', title: 'Monitoreo ambiental y KPIs en planta', language: 'es', pdfPath: getPdfPath('monitoreo-kpis'), bilingualPairId: 'en-9' },
  ...
  { id: 'es-12', slug: 'fauna-urbana', title: 'Biblioteca de Sostenibilidad Industrial: Convivencia con fauna urbana', language: 'es', pdfPath: getPdfPath('fauna-urbana'), bilingualPairId: 'en-10' },
];
...
export const ENGLISH_STORYBOOKS: Storybook[] = [
  ...
  { id: 'en-3', slug: 'operational-noise', title: 'Operational Noise and Nature', language: 'en', pdfPath: getPdfPath('operational-noise'), bilingualPairId: 'es-3' },
  ...
  { id: 'en-9', slug: 'biodiversity-monitoring', title: 'Environmental Monitoring and KPIs at the Plant', language: 'en', pdfPath: getPdfPath('biodiversity-monitoring'), bilingualPairId: 'es-9' },
  { id: 'en-10', slug: 'urban-fauna-coexistence', title: 'Sustainable Aviation Learning Library: Urban Fauna Coexistence', language: 'en', pdfPath: getPdfPath('urban-fauna-coexistence'), bilingualPairId: 'es-12' },
  { id: 'en-11', slug: 'pollinators-industrial-en', title: 'Sustainable Aviation Learning Library: Pollinators in Industrial Environments', language: 'en', pdfPath: getPdfPath('pollinators-industrial-en'), bilingualPairId: 'es-10' },
